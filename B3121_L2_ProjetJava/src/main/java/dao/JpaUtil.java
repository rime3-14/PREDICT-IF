...
public class JpaUtil {
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "dasi_PredictIF_B3121_jar_1.0-SNAPSHOTPU";
    /**
    ...
    /**
     * Démarre une transaction sur l'instance courante du Contexte de Persistance (Entity Manager).<br><strong>À utiliser uniquement au niveau Service.</strong>
